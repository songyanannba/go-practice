...
func NewUnit(run public.RunSlotTest) *Unit5 {
	return &Unit5{Result: unit5Result{BasicData: &public.BasicData{}}}
}

func (u *Unit5) Repeat(run public.RunSlotTest, opts ...component.Option) ([]*component.Spin, error) {
...
func (u *Unit5) Calculate(spins []*component.Spin) {
	...
	//Free赢钱倍数
	{
		...
		freeParents := lo.Filter(mSpins, func(s *component.Spin, index int) bool {
			return s.FreeSpinParams.FreeNum > 0 && s.Id != 0
		})
		sumFreeSumGain := 0
...
func (u *Unit5) GetBasicData() *public.BasicData {
	return u.Result.BasicData
}

func (u *Unit5) GetResult(spins []*component.Spin) (int64, int64) {
...
func (u *Unit5) GetReturnRatio() float64 {
