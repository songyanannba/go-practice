...
func NewUnit(run public.RunSlotTest) *Unit7 {
	return &Unit7{Result: unit7Result{BasicData: &public.BasicData{}}}
}

func (u *Unit7) Repeat(run public.RunSlotTest, opts ...component.Option) ([]*component.Spin, error) {
...
func (u *Unit7) Calculate(spins []*component.Spin) {
...
func (u *Unit7) GetBasicData() *public.BasicData {
	return u.Result.BasicData
}

func (u *Unit7) GetResult(spins []*component.Spin) (int64, int64) {
...
func (u *Unit7) GetReturnRatio() float64 {
